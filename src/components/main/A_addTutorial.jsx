...
const A_addTutorial = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (match && match[1]) {
      ...
      fetch(
        "https://programminghero-job-ta-backend.vercel.app/admin/allTutorials",
        {
          method: "POST",
          headers: {
      ...
      toast.error(
        "Invalid iframe embed code. Please provide a valid YouTube iframe embed code."
      );
    }
  };
      ...
      <div className="bg-[#EDF8FA] p-6 min-h-screen flex justify-center items-center">
        <div className="w-full max-w-xl bg-white p-8 rounded-lg shadow-xl">
          ...
          <div className="mb-6 text-center">
            ...
            <p className="mt-2 text-lg text-[#2262A6]">
              Add details for the new tutorial
            </p>
          </div>
